...
urlpatterns = [
    ...
    path(
        "active-account/<uid>/<token>/", AcctiveAccount.as_view(), name="veryfi_email"
    ),
    ...
    path(
        "reset-password/<uid>/<token>/", ResetPassword.as_view(), name="reset_password"
    ),
