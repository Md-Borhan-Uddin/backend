from .views import (
    ...
    AssetByRealestate, RealestateCount, RealEstateRetrieveDestroyAPIView,RealEstateDetailAPIView
    )
...
urlpatterns = [
    ...
    path("real-estate/details/", RealEstateDetailAPIView.as_view(), name="realestate_details"),
